...
def test_translate_node():
    ...
    translate_node = mg.MapGraph.translate_node.im_func
...
class TranslateEdgeTestCase(MockerTestCase):
    ...
    def setUp(self):
        self.translate = mg.MapGraph.translate_edge.im_func

    def test_two_maps(self):
        g = self.mocker.mock()
        g.translate_node('A-1', 'B')
        self.mocker.result(['B-1', 'B-2'])
        g.translate_node('A-2', 'C')
